...
class Score {
    ...
    companion object {
        ...
        fun fromContentValues(values: ContentValues): Score {
            val scoreData = Score()
        ...
        val names = arrayOf(
            "Adrian Pucey", "Alastor Mad Eye Moody", "Albus Dumbledore", "Alguff Awful", "Alice Longbottom", "Alicia Spinnet", "Ambrosius Flume", "Amelia Susan Bones",
