 ...
 *
 * Note from other of my examples, this doesn't automatically set the ID, because we are letting the rest
 * service set the id number and we are just using it.
 */
